...
module.exports = {
  ...
  ECOVILLAGEGLOBAL_API_BASE: process.env.SEMAPPS_ECOVILLAGEGLOBAL_API_BASE,
  ECOVILLAGEGLOBAL_API_USER: process.env.SEMAPPS_ECOVILLAGEGLOBAL_API_USER,
  ECOVILLAGEGLOBAL_API_PASSWORD: process.env.SEMAPPS_ECOVILLAGEGLOBAL_API_PASSWORD,
